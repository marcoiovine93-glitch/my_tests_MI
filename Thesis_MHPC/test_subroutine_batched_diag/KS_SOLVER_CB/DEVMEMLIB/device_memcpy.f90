...
!!=======================
!
! Asynchronous device-to-device copy routines for dp_dev_memcpy
!
subroutine dp_dev_memcpy_async_r1d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_r1d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end) = &
              array_in(d1_start:d1_end)
#endif
...
subroutine dp_dev_memcpy_async_r2d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size*d2_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_r2d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end,d2_start:d2_end) = &
              array_in(d1_start:d1_end,d2_start:d2_end)
#endif
...
subroutine dp_dev_memcpy_async_r3d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size*d2_size*d3_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_r3d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end) = &
              array_in(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end)
#endif
...
subroutine dp_dev_memcpy_async_r4d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size*d2_size*d3_size*d4_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_r4d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end,d4_start:d4_end) = &
              array_in(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end,d4_start:d4_end)
#endif
...
subroutine dp_dev_memcpy_async_c1d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_c1d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end) = &
              array_in(d1_start:d1_end)
#endif
...
subroutine dp_dev_memcpy_async_c2d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size*d2_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_c2d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end,d2_start:d2_end) = &
              array_in(d1_start:d1_end,d2_start:d2_end)
#endif
...
subroutine dp_dev_memcpy_async_c3d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size*d2_size*d3_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_c3d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end) = &
              array_in(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end)
#endif
...
subroutine dp_dev_memcpy_async_c4d(array_out, array_in, stream, &
    ...
    ierr = CudaMemcpyAsync(array_out, array_in, &
                           count=d1_size*d2_size*d3_size*d4_size,&
                           kdir=cudaMemcpyDeviceToDevice,stream=stream)
    if ( ierr /= 0) call dxlib_errore("dp_dev_memcpy_async_c4d",cudaGetErrorString(ierr),ierr)
#else
    array_out(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end,d4_start:d4_end) = &
              array_in(d1_start:d1_end,d2_start:d2_end,d3_start:d3_end,d4_start:d4_end)
#endif
