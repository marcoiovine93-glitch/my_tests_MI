...
do i = 1, num_k
    !! Case with n = 6 :
    matr2D_a(1,1,i) = (2.0D0,  1.0D0)
    matr2D_a(2,2,i) = (3.0D0, -1.0D0)
    matr2D_a(3,3,i) = (1.5D0,  2.0D0)
    matr2D_a(4,4,i) = (-4.0D0, 1.0D0)
    matr2D_a(2,1,i) = (1.0D0,  0.5D0)
    matr2D_a(3,1,i) = (0.0D0,  2.0D0)
    matr2D_a(3,2,i) = (-1.0D0, 0.0D0)
    matr2D_a(4,1,i) = (0.5D0, -1.0D0)
    matr2D_a(4,2,i) = (3.0D0,  0.0D0)
    matr2D_a(4,3,i) = (1.0D0,  1.0D0)
    matr2D_a(1,2,i) = (0.0D0, 0.0D0)
    matr2D_a(1,3,i) = (0.0D0, 0.0D0)
    matr2D_a(1,4,i) = (0.0D0, 0.0D0)
    matr2D_a(2,3,i) = (0.0D0, 0.0D0)
    matr2D_a(2,4,i) = (0.0D0, 0.0D0)
    matr2D_a(3,4,i) = (0.0D0, 0.0D0)
    
    matr2D_b(1,1,i) = (2.0D0, 1.0D0)
    matr2D_b(2,2,i) = (2.0D0, -1.0D0)
    matr2D_b(3,3,i) = (3.0D0, 2.0D0)
    matr2D_b(4,4,i) = (-1.0D0, 1.0D0)
    matr2D_b(1,2,i) = (2.0D0, -1.0D0)
    matr2D_b(1,3,i) = (0.0D0, 0.0D0)
    matr2D_b(1,4,i) = (1.0D0, 0.0D0)
    matr2D_b(2,1,i) = (0.0D0, 0.0D0)
    matr2D_b(2,3,i) = (1.0D0, 1.0D0)
    matr2D_b(2,4,i) = (0.0D0, 0.0D0)
    matr2D_b(3,1,i) = (1.0D0, 0.0D0)
    matr2D_b(3,2,i) = (0.0D0, 0.0D0)
    matr2D_b(3,4,i) = (0.0D0, -1.0D0)
    matr2D_b(4,1,i) = (7.0D0, 3.0D0)
    matr2D_b(4,2,i) = (1.0D0, 0.0D0)
    matr2D_b(4,3,i) = (0.0D0, 1.0D0)
